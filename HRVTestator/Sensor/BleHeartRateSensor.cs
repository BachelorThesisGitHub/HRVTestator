...
{
    public class BleHeartRateSensor : BleSensor<float[]> {

        private readonly static String TAG = typeof(BleHeartRateSensor).Name; ///BleHeartRateSensor.class.getSimpleName();

        private static readonly String UUID_SENSOR_BODY_LOCATION = "00002a38-0000-1000-8000-00805f9b34fb";
    
    private static readonly int SENSOR_BODY_LOCATION_OTHER = 0;
        private static readonly int SENSOR_BODY_LOCATION_CHEST = 1;
        private static readonly int SENSOR_BODY_LOCATION_WRIST = 2;
        private static readonly int SENSOR_BODY_LOCATION_FINGER = 3;
        private static readonly int SENSOR_BODY_LOCATION_HAND = 4;
        private static readonly int SENSOR_BODY_LOCATION_EAR = 5;
        private static readonly int SENSOR_BODY_LOCATION_FOOT = 6;
